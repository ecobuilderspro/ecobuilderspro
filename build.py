...
MAIL = "mailto:ecobuilderspro@gmail.com?subject=Project%20Inquiry%20-%20EcoBuilders"
  ...
  <footer>
    <div class="container footer-grid">
      ...
      <div>
        ...
        <p>Noah Schij<br>
          <a href="mailto:ecobuilderspro@gmail.com">ecobuilderspro@gmail.com</a><br>
          <button type="button" class="phone-reveal">Click to show number</button><br>
          Seal Beach, CA</p>
      </div>
      <div>
...
P = {
 ...
 "dcfast-corridor": dict(
    ...
    images=[("dcfast-corridor-set.jpg", "Charger cabinet craned onto its pad."),
            ("dcfast-corridor-transformer.jpg", "Pad-mount transformer offloaded ahead of the charger set."),
 ...
 "mf-riverside": dict(
    ...
    specs="Remove, store and reinstall · pedestals and EVSE",
    note="Phased removal and reinstallation coordinated around site construction.",
 ...
 "fleet-torrance": dict(
    title="Food & Beverage Fleet Depot · Torrance, CA",
    specs="Fleet depot charging",
    note="Charger service and support at an electric truck fleet facility.",
 ...
 "solar-research": dict(
    ...
    specs="Rooftop array",
    note="Solar installation supporting a research campus.",
    images=[("solar-research-la-jolla.jpg", "Rooftop array across the research campus.")]),
 ...
 "storage-san-diego": dict(
    ...
    images=[("storage-rigging.jpg", "Rigging the battery equipment into position."),
            ("campus-san-diego.jpg", "Equipment on the hook above the pad."),
            ("sitework-equipment-pad.jpg", "Precast equipment pad and conduit stub-ups.")]),
 "storage-winery": dict(
 ...
 "comm-winery": dict(
    ...
    specs="Solar · storage · generator",
    note="Functional testing and documentation across three integrated systems.",
 ...
 # ---- O&M
 "om-inverter": dict(
    title="Energized Inverter Testing",
    specs="Arc-flash rated · NFPA 70E",
    note="Diagnostics at energized DC equipment under full arc-flash protection.",
    images=[("om-inverter-test.jpg", "Testing at an open combiner inside the inverter.")]),
 "om-iv": dict(
 ...
 "om-charging": dict(
    ...
    note="Troubleshooting, feeder replacement and uptime support across charging portfolios.",
 ...
 "controls-ct": dict(
    ...
    note="Metering that lets charging ramp to the capacity actually available.",
...
SERVICES = [
  dict(file="ev-charging.html", name="EV Charging Infrastructure",
       ...
       sections=[("DC Fast Charging", ["dcfast-bakersfield", "dcfast-blythe", "dcfast-chula-vista", "dcfast-corridor"]),
                 ...
                 ("Workplace & Campus", ["campus-san-diego", "hospital-montebello", "hospital-irwindale",
                                          "hospital-baldwin-park", "hospital-diamond-bar", "museum-los-angeles"]),
  ...
  dict(file="energy-storage.html", name="Energy Storage",
       ...
       flat=["storage-san-diego", "storage-winery"]),
  ...
  dict(file="commissioning.html", name="Commissioning",
       ...
       flat=["comm-setup", "comm-energize", "comm-termination", "comm-winery"]),
  ...
  dict(file="om.html", name="O&amp;M",
       ...
       flat=["om-charging", "om-inverter", "om-iv", "om-thermal"]),
      ...
      <div class="container">
        ...
        <div class="contact-grid">
          <div class="contact-card">
            ...
            <p><strong>Email:</strong><br><a href="mailto:ecobuilderspro@gmail.com">ecobuilderspro@gmail.com</a></p>
